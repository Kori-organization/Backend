...
let studentEnrollment = window.APP_CONFIG?.studentEnrollment;
...
function initializeConversation() {
    ...
    conversationMessages.innerHTML = `
        <div class="message bot">
            <img src="${contextPath}/assets/blue-monster2.svg" alt="Bot">
            <div class="bubble">
                Olá! Estou aqui para te auxiliar na plataforma Kori. Você pode me fazer perguntas sobre seu desempenho, estudos e uso da plataforma.
            </div>
        </div>
    `;
...
async function sendQuestionToAI(question) {
    const payload = {
        enrollment: Number(studentEnrollment),
        question: question
    };
